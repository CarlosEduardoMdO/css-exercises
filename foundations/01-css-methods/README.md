...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? Sim
- Did you properly link the external CSS file in the HTML file? Sim
- Does the `div` element have CSS added via the external method? Sim
- Does the `p` element have CSS added via the internal method?
- Does the `button` element have CSS added via the inline method? Sim
